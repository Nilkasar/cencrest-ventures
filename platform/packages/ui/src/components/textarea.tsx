...
/** Multi-line counterpart to `Input` — same label/description/error
 *  contract and the same border/focus/error visual treatment, so a form
 *  mixing both never looks like two different systems. */
export const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(function Textarea(
  { className, containerClassName, label, description, error, id, rows = 3, ...props },
  ref,
) {
